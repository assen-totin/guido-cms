...
var init = function(params, callback) {
	...
	switch(params.method) {
		case 'GET':
			// Get the page
			var q = "SELECT * FROM pages WHERE language_id=" + sqlClient.escape(params.query.language) + " AND navigation_id=" + sqlClient.escape(params.query.navigation);
